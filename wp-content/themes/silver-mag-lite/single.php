	...
	<div id="tp-section-left" <?php post_class('eleven columns');?>>	 		
		...
		<!-- post-content-->
			...
			<div class="single-navigation clearfix">
					<div class="previous"><?php previous_post_link('%link', __( '<span>Previous: </span> %title', 'silvermag' ) ); ?></div>
					<div class="next"><?php next_post_link('%link', __( '<span>Next: </span> %title', 'silvermag' ) ); ?></div>
					 <?php  ?>
				</div>
				<!-- /single-navigation-->
