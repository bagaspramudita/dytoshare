 ...
 * @since 0.1
 */
 add_action( 'widgets_init', 'silvermag_recent_category_widget' );
 /**
 * Register our widget.
 ...
 * @since 0.1
 */
  function silvermag_recent_category_widget() {
	register_widget( 'silvermag_recent_category_widget' );
}
/**
 ...
 * @since 0.1
 */
class silvermag_recent_category_widget extends WP_Widget {
  function silvermag_recent_category_widget() {
  $widget_ops = array('classname' => 'silvermag_recent_category_widget','description' => __( 'A Widget to dispaly Category Posts With Thumbs', 'silvermag' ));
  $this->WP_Widget('tpcrn-cat-posts-widget', __( 'ThemePacific : Category Posts Widget', 'silvermag' ), $widget_ops);	
	}
 				...
 				'cat' => $get_catego,
					...
					<li>
						...
						<?php if ( has_post_thumbnail() ) { ?>
							<a class="post-thumbnail" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_post_thumbnail('sb-post-thumbnail', array('title' => get_the_title())); ?></a>
						<?php } else { ?>
...
/**
	...
	function form( $instance ) {
				...
				$defaults = array( 'title' => __('Category Name ', 'silvermag '),'getnumpost' => '3','get_catego' => 'all');
