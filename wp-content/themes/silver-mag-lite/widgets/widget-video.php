...
add_action( 'widgets_init', 'silvermag_video_widget_box' );
function silvermag_video_widget_box() {
	register_widget( 'silvermag_video_widget' );
}
class silvermag_video_widget extends WP_Widget {

	function silvermag_video_widget() {
		$widget_ops = array( 'classname' => 'silvermag_video-widget', 'description' => 'Show YouTube and Viemo Video'  );
		$control_ops = array('id_base' => 'silvermag_video-widget' );
		$this->WP_Widget( 'silvermag_video-widget','ThemePacific: Video Widget', $widget_ops, $control_ops );
	}
