 ...
 * @since 0.1
 */
 add_action( 'widgets_init', 'silvermag_popular_posts_widget' );
 /**
 * Register our widget.
 ...
 * @since 0.1
 */
  function silvermag_popular_posts_widget() {
	register_widget( 'silvermag_popular_posts_widget' );
}
/**
 ...
 * @since 0.1
 */
class silvermag_popular_posts_widget extends WP_Widget {
  function silvermag_popular_posts_widget() {
  $widget_ops = array('classname' => 'silvermag_popular_posts_widget','description' => __( 'A Widget to dispaly Popular Posts With Thumbs', 'silvermag' ));
  $this->WP_Widget('tpcrn-popular-posts-widget', __( 'ThemePacific : Popular Posts Widget', 'silvermag' ), $widget_ops);	
	}
...
/**
	...
	function form( $instance ) {
				...
				$defaults = array( 'title' => __('Popular Posts ', 'silvermag'),'getnumpost' => '3');
